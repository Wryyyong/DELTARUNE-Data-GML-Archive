...
function scr_rhythmgame_load_events(arg0) {
	if (arg0 == 0) {
		with (drums) {
			scr_music_event_add_instance(performer, 16.7 - (meter * 6), "sprite_index", 24, true);
			scr_music_event_add_instance(other.performer, 16.7 - (meter * 5.75), "sprite_index", 272, true);
			scr_music_event_add_instance(other.vocals.performer, 16.7 - (meter * 5.5), "sprite_index", 3513, true);
			...
			scr_music_event_add_instance(other.vocals.performer, 16.7 - (meter * 4), "sprite_index", 4059, true);
			...
			scr_music_event_add_instance(other.vocals.performer, 38, "sprite_index", 2985, true, 1);
			...
			scr_music_event_add_instance(other.vocals.performer, 134.5, "sprite_index", 2985, true, 1);
		...
		with (drums) {
			...
			other.spooked = true;
			scr_music_event_add_instance(performer, trackstart + (meter * 0.5), "sprite_index", 1795, true);
			scr_music_event_add_instance(performer, trackstart + (meter * 0.5), "image_index", 1, true);
			scr_music_event_add_instance(other.performer, trackstart + (meter * 1.5), "sprite_index", 272, true);
			scr_music_event_add_instance(other.vocals.performer, trackstart + (meter * 1), "sprite_index", 2985, true, 1);
			scr_music_event_add(trackstart + (meter * 2), "fade", 1, false);
			scr_music_event_add_instance(performer, 11, "sprite_index", 1903, true);
			scr_music_event_add_instance(performer, 14.3, "image_speed", 1, true);
			scr_music_event_add_instance(other.vocals.performer, 14.3, "sprite_index", 4059, true);
			...
			scr_music_event_add_instance(performer, 23.5, "sprite_index", 24, true);
			scr_music_event_add_instance(performer, 24, "sprite_index", 3106, true);
		}
	} else if (arg0 == 2) {
		drums.auto_play = 1;
		...
		if (chart_start <= 158.92 && chart_end >= 158.92) {
			with (vocals.performer) {
				...
				scr_music_event_add(158.92, "sprite_index", 4557, true);
				scr_music_event_add(162.16, "sprite_index", 450, true);
				...
				scr_music_event_add(165.4, "sprite_index", 2985, true);
			}
		}
	} else if (arg0 == 4) {
		scr_music_event_add_instance(other.performer, trackstart + (meter * 1.5), "sprite_index", 272, true);
		...
		scr_music_event_add_instance(drums.performer, trackstart + (meter * 0.5), "sprite_index", 24, true);
		scr_music_event_add_instance(other.performer, trackstart + (meter * 1.5), "sprite_index", 272, true);
		scr_music_event_add_instance(vocals.performer, trackstart + (meter * 1), "sprite_index", 2985, true, 1);
	}
	
	scr_music_beat_event_instance(841, "beat", true, true);
}
