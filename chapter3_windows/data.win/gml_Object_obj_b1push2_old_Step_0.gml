...
if (active == 1) {
	...
	if (con == 0 && obj_board_camera.con == 0) {
		...
		if (letsstart == 1) {
			...
			hazard[0] = instance_create_board(5, 0, 322);
			hazard[1] = instance_create_board(6, 0, 322);
			hazard[2] = instance_create_board(0, 3, 322);
			hazard[3] = instance_create_board(0, 4, 322);
			hazard[4] = instance_create_board(5, 7, 322);
			hazard[5] = instance_create_board(6, 7, 322);
			hazard[6] = instance_create_board(11, 3, 322);
			hazard[7] = instance_create_board(11, 4, 322);
