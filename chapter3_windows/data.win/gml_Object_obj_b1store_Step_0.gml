...
if (active == 1) {
	...
	if (made == 0 && obj_board_camera.con == 0) {
		instance_create_board(3, 4.5, 283);
		instance_create_board(8, 4.5, 283);
		key = instance_create_board(3, 4.5, 162);
		key.cost = 250;
		heal = instance_create(x + board_tilex(3), y + board_tiley(1.5), obj_board_tvdinner);
		heal.active = true;
		tennamarker = instance_create_board(5.5, 1.25, 117);
		...
		tennasolid = instance_create_board(5.5, 1.25, 322);
