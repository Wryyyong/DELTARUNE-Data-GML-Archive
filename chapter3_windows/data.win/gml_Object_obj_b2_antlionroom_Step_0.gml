...
if (active == 1) {
	...
	if (con == 0 && obj_board_camera.con == 0) {
		if (!made) {
			made = 1;
			antlion[0] = instance_create_board(2, 3, 229);
			antlion[1] = instance_create_board(2, 5, 229);
			antlion[2] = instance_create_board(8, 4, 229);
			antlion[3] = instance_create_board(5, 4, 229);
			antlion[0].boss = true;
