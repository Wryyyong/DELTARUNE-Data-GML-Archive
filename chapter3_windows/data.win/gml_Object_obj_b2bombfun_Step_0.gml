...
if (active == 1) {
	...
	if (con == 0 && obj_board_camera.con == 0) {
		...
		if (global.flag[1190] == 0) {
			tempblock = instance_create_board(1, 3, 322);
	...
	if (con == 2) {
		checkleave = 1;
		block = instance_create_board(1, 4, 382);
	...
	if (con == 3) {
		...
		if (timer == 1) {
			...
			instance_create_board(3, 2, 62);
			instance_create_board(3, 4, 62);
			instance_create_board(5, 2, 62);
			instance_create_board(5, 4, 62);
			instance_create_board(6, 2, 62);
			instance_create_board(6, 4, 62);
			instance_create_board(8, 2, 62);
			instance_create_board(8, 4, 62);
