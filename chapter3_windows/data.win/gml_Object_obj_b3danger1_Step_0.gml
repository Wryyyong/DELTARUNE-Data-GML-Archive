...
if (active == 1) {
	...
	if (obj_board_camera.con == 0 && triggered) {
		...
		if (guntimer == (rate * 1)) {
			...
			mygunner1 = instance_create_board(1, 1, 202);
		}
		
		if (guntimer == (rate * 2)) {
			safe_delete(mygunner1);
			mygunner2 = instance_create_board(10, 6, 202);
		}
		
		if (guntimer == (rate * 3)) {
			safe_delete(mygunner2);
			mygunner1 = instance_create_board(3, 1, 202);
		}
		
		if (guntimer == (rate * 4)) {
			safe_delete(mygunner1);
			mygunner2 = instance_create_board(8, 6, 202);
		}
