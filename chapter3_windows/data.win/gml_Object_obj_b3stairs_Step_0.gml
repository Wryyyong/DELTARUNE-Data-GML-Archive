...
if (active == 1) {
	...
	if (con == 1.9) {
		...
		if (timer == 80) {
			with (scr_board_marker(1792, 1632, 634, 0, 999995, 2))
				setxy_board(x, y);
	...
	if (con == 4) {
		...
		if (timer == 10) {
			...
			with (scr_board_marker(board_tilex(0), board_tiley(0), 4402, 0, 990000, 2))
				image_index = 0;
			
			var tetalk;
			
			with (scr_board_marker(board_tilex(1), board_tiley(2), 163, 1, 989995, 1, 0))
		...
		if (timer == 210) {
			...
			with (scr_board_marker(board_tilex(0), board_tiley(0), 1043, 0, 989990)) {
