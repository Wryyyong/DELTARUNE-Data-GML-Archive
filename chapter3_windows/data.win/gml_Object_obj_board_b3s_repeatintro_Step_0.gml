...
if (con == 0) {
	...
	markerbar = scr_board_marker(board_tilex(0), board_tiley(-1), 412, 0, 100000, 32);
...
if (con == 10) {
	global.currentsong[0] = snd_init("root_8bit.ogg");
	global.currentsong[1] = mus_loop_ext(global.currentsong[0], 1, 1);
	fader = scr_board_marker(board_tilex(0), board_tiley(0), 412, 0, 100000, 640);
