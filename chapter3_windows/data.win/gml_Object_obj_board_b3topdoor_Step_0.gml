...
if (myinteract == 22) {
	...
	if (timer == 20) {
		...
		q1 = scr_board_marker(88, 74, 4841, 0, 5000, 2);
	...
	if (timer == 30) {
		...
		q2 = scr_board_marker(88, 74, 4841, 0, 5000, 2);
	...
	if (timer == (basetime + 60 + 10)) {
		...
		with (scr_board_marker(1440, 384, 4343, 0, 999998, 2))
			setxy_board(x, y);
...
if (i_ex(q1)) {
	with (q1) {
		if (depth == 900000) {
			if ((other.timer % 4) == 0) {
				var star = scr_board_marker(x + irandom_range(-8, 8), y + 14, 282, 0, depth, 2);
