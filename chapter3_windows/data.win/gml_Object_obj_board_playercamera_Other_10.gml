...
var _num = collision_rectangle_list(x + 4, y + 4, (x + (camwidth * 32)) - 4, (y + (camheight * 32)) - 4, 1043, false, true, _list, false);
...
_num = collision_rectangle_list(x + 4, y + 4, (x + (camwidth * 32)) - 4, (y + (camheight * 32)) - 4, 66, false, true, _list, false);
