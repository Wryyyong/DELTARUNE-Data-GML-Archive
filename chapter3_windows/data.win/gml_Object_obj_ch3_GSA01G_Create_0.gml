...
textfade = 20;
tennafade = 8;
screenshot_overlay = scr_marker_ext(0, 0, 4886);
...
screenshot_tenna = scr_marker_ext(0, 0, 1378);
...
prize1splash = scr_marker_jitter(camerax(), cameray(), 215);
prize1splash.image_index = 0;
prize1splash.depth = 9999;
prize1object = scr_marker_jitter(camerax() + 20, cameray() + 180, 4359);
prize1object.image_index = 0;
prize1object.depth = 9998;
prize1object.image_xscale = 1;
prize1object.image_yscale = 1;
prize2splash = scr_marker_jitter(camerax(), cameray(), 215);
