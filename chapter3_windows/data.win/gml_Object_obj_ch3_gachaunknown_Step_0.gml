...
if (init == 0) {
	with (scr_marker_ext(0, 0, 412, room_width, room_height, undefined, undefined, 0, 0, undefined, undefined, 1))
...
if (con == 5) {
	...
	if (timer == 30) {
		fade = scr_marker_ext(camerax(), cameray(), 412, 640, 480, 0, 0, 0, -40);
		fade.image_alpha = 0;
