if (view_current == 0) {
	...
	ossafe_fill_rectangle_color(camerax(), cameray() + startY, camerax() + 640, cameray() + endY, 0, 0, 16777215, 16777215, 0);
	var lwallstart = 200;
	var lwallfade = 200;
	...
	ossafe_fill_rectangle_color(lwallstart, 0, lwallstart + lwallfade, 480, 16777215, 0, 0, 16777215, 0);
	...
	ossafe_fill_rectangle_color(rightx, 0, rightx - 400, 480, 0, 16777215, 16777215, 0, 0);
