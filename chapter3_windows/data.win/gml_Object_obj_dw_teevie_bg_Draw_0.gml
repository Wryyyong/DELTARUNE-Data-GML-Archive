...
var middle_pos = 80;
ossafe_fill_rectangle_color(0, 0, room_width, middle_pos, 0, 0, 6170148, 6170148, false);
ossafe_fill_rectangle_color(0, middle_pos, room_width, max_y, 6170148, 6170148, 0, 0, false);
...
draw_set_alpha(0.5);
ossafe_fill_rectangle_color(0, 0, room_width, max_y, 6170148, 6170148, 0, 0, false);
draw_set_alpha(1);
