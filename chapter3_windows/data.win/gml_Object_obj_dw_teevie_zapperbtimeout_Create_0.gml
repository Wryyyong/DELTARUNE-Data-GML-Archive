...
if (makeme) {
	...
	scr_marker_ext(x, y, sprite_index, 2, 2, 0, 1, 16777215, 1000040);
	
	with (scr_marker_ext(x, y, sprite_index, 2, 2, 0, 0, 16777215, 1000040))
		scr_depth();
	
	chain = scr_marker_ext(x + 110, y + 86, 408, 2, 2, 0, 0);
	chain.depth = depth - 1;
	chain.image_speed = 0;
