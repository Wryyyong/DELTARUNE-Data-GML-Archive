...
if (con == 2 || con == 3) {
	...
	if (difficulty == 2) {
		...
		if (difficulty != 2) {
			scr_draw_beam_color(x, y, _sublength, 10, 156, 16777215, 0, _a, false);
			scr_draw_beam_color(x, y, _sublength, 10, 24, 16777215, 0, _a, false);
			scr_draw_beam_color(x, y, _sublength, 10, 270, 16777215, 0, _a, false);
		}
