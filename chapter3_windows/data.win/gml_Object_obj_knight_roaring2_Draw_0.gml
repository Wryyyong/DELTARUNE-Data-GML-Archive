...
draw_clear_alpha(c_black, 0);
ossafe_fill_rectangle_color(0, 0, camerawidth(), cameraheight(), 0, 0, 0, 0, false);
...
if (do_fake_screen) {
	...
	draw_set_alpha(0);
	ossafe_fill_rectangle_color(midway + 120, -1, camerawidth(), cameraheight(), 0, 0, 0, 0, false);
	draw_triangle_color(midway - 120, -1, midway + 120, cameraheight(), midway + 120, -1, 0, 0, 0, false);
	draw_set_alpha(1);
	...
	gpu_set_blendenable(false);
	draw_set_alpha(0);
	ossafe_fill_rectangle_color(midway - 119, 0, -1, cameraheight(), 0, 0, 0, 0, false);
	draw_triangle_color(midway - 120, 0, midway - 120, cameraheight(), midway + 120, cameraheight(), 0, 0, 0, false);
	draw_set_alpha(1);
	gpu_set_blendenable(true);
	surface_reset_target();
