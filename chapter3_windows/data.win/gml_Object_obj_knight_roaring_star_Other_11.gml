...
if (con == 2 || con == 2.5 || con == 3) {
	...
	scr_draw_beam_color(_topx, _topy, _length, 10, 90, 16777215, 0, _a, false);
	scr_draw_beam_color(_bottomx, _bottomy, _length, 10, 156, 16777215, 0, _a, false);
	scr_draw_beam_color(_topx, _topy, _length, 10, 24, 16777215, 0, _a, false);
	scr_draw_beam_color(_bottomx, _bottomy, _length, 10, 270, 16777215, 0, _a, false);
	scr_draw_beam_color(_topx, _topy, _length, 10, 336, 16777215, 0, _a, false);
	scr_draw_beam_color(_bottomx, _bottomy, _length, 10, 204, 16777215, 0, _a, false);
