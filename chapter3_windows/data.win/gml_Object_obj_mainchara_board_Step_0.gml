...
if (susierecordcon == 2) {
} else if (controlled == obj_board_anchor) {
	if (left_h())
		press_l = 1;
...
if (fun == 0 && is_moving == false) {
	...
	if ((name == "ralsei" || name == "susie") && controlled == obj_b1mailroom_intro)
		disable = 1;
...
if (onebuffer <= 0 && controlled == obj_board_anchor && swordbuffer <= 0 && global.interact == 0 && !instance_exists(obj_board_playercamera) && press_1 == 1 && controlled == obj_board_anchor && (name == "kris" || caninteract == true)) {
	onebuffer = 6;
	thisinteract = 0;
...
if (camera == true && name == "kris" && controlled == obj_board_anchor && (canfreemove == true || (boat == true && !i_ex(obj_board_playercamera))) && global.interact == 0 && obj_board_camera.con == 0 && interacted == 0 && cambuff <= 0 && !instance_exists(obj_gameover_minigame)) {
...
if (press_1 == 1 && controlled == obj_board_anchor && name == "kris" && sword == true && swordbuffer <= 0 && (global.interact == 0 || interactoverride == true) && (canfreemove == 1 || boat == true) && obj_board_camera.con == 0 && interacted == 0) {
	swordbuffer = 8;
	swordfacing = facing;
	canfreemove = 0;
...
if (name == "ralsei") {
	...
	if ((controlled == obj_board_anchor && global.interact == 0) || goStoole == 1) {
	...
	if ((stoolforme == 2 && controlled == obj_board_anchor && global.interact == 0 && (press_1 == 1 || press_2 == 1) && stoolbuff <= 0) || unstoole == 1) {
		unstoole = 0;
...
if ((hookshot == true && hookbuff <= 0 && button2_p() && canfreemove == true && controlled == obj_board_anchor && grab == 0 && global.interact == 0 && name != "ralsei") || forcehook == true) {
	forcehook = false;
...
if (controlled == obj_board_anchor) {
	...
	if (canfreemove == 1 && controlled == obj_board_anchor && boat == false && (name == "kris" || susieholdingkris == true || totaloverwrite) && !freeroam) {
...
if (is_moving == 0 && controlled == obj_b1mailroom_intro) {
	x = round(x);
	y = round(y);
}
...
if (stink) {
	...
	if ((stinktimer % 5) == 0) {
		...
		var stinky = scr_board_marker(_sx + 16 + irandom_range(-8, 8), _sy + 2, 412, 0, depth + 1, choose(2, 2, 2, 2, 2, 4));
