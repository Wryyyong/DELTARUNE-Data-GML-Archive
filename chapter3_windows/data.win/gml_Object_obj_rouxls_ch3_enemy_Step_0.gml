...
if (global.monster[myself] == 1) {
	...
	if (scr_isphase("enemytalk") && yarnendturn == 0) {
		if (turns == 0) {
			...
			if (dancecon == 2) {
				scr_battle_sprite_set("kris", 455, 0.25, 1);
				obj_herokris.y += 15;
				scr_battle_sprite_set("susie", 391, 0.25, 1);
				
				if (obj_heroralsei.sprite_index != spr_ralseib_yarn_1 && obj_heroralsei.sprite_index != spr_ralseib_yarn_2) {
					scr_battle_sprite_set("ralsei", 316, 0.25, 1);
					obj_heroralsei.y += 4;
				}
	...
	if (endcon != 0) {
		...
		if (endcon == 4.5) {
			if ((button3_p() && endtalktimer > 15) || !i_ex(obj_writer)) {
				...
				myblcon.side = -1;
				scr_battle_sprite_set("susie", 704, 0, 1);
				...
				scr_enemyblcon(obj_heroralsei.x + 85, obj_heroralsei.y + 45, 10);
				myblcon.side = -1;
				scr_battle_sprite_set("ralsei", 332, 0, 1);
		...
		if (endcon == 22) {
			...
			if (talktimer == 60) {
				scr_battle_sprite_set("susie", 709, 1/3, 1);
