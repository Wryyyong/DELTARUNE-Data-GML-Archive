...
ossafe_fill_rectangle_color(targetid.x - offset, targetid.y - offset, targetid.x + 96 + offset, targetid.y + 100 + offset, 255, 255, 255, 255, true);
ossafe_fill_rectangle_color(targetid.x - 1 - offset, targetid.y - 1 - offset, targetid.x + 96 + 1 + offset, targetid.y + 100 + 1 + offset, 255, 255, 255, 255, true);
draw_set_alpha(1);
...
if (character == "susie") {
	...
	if (con == 3) {
		...
		ossafe_fill_rectangle_color(targetid.x - offset, targetid.y - offset, targetid.x + 96 + offset, targetid.y + 100 + offset, 16777215, 16777215, 16777215, 16777215, false);
		draw_set_alpha(1);
		alpha2 -= 0.05;
	}
} else {
