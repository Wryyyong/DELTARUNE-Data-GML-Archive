...
switch (subact_state) {
	...
	case "intro":
		...
		if (krs_time >= krs_duration) {
			...
			scr_battle_sprite_set("ralsei", 4653, 0, true);
			obj_heroralsei.image_index = 2;
			scr_battle_sprite_set("kris", 248, 0, true);
			scr_battle_sprite_set("susie", 394, 0, true);
		}
	...
	case "pose":
		...
		if (krs_time == 0) {
			switch (pattern) {
				case 0:
					scr_battle_sprite_set("susie", 418, 0, true);
					break;
				...
				case 1:
					...
					obj_herokris.y += 2;
					obj_herosusie.y += 2;
					scr_battle_sprite_set("kris", 3098, 0, true);
					scr_battle_sprite_set("susie", 3665, 0, true);
					break;
				
				case 2:
					scr_battle_sprite_set("susie", 391, 0, true);
					break;
				
				case 3:
					scr_battle_sprite_set("susie", 417, 0, true);
					break;
			}
		}
	...
	case "final_pose":
		if (krs_time == 0) {
			...
			obj_herosusie.x -= 2;
			scr_battle_sprite_set("susie", 461, 0, true);
			obj_herosusie.depth = obj_heroralsei.depth + 1;
			obj_herosusie.image_index = 1;
			scr_battle_sprite_set("kris", 3665, 0, true);
		}
	...
	case "capture":
		if (krs_got_funny) {
			scr_battle_sprite_set("ralsei", 3585, 0, true);
			scr_battle_sprite_set("susie", 461, 0, true);
