...
if (bar_v > 0)
	ossafe_fill_rectangle_color(obj_growtangle.x - bar_width, obj_growtangle.y - bar_height, obj_growtangle.x + bar_width, obj_growtangle.y + bar_height, 16777215, 16777215, 16777215, 16777215);
