...
if (con == 0) {
	timer = -5;
	sans = scr_marker_ext(293, 210, 2740, 1, 1, 0, undefined, undefined, 50);
	asgore = scr_marker_ext(240, 204, 2486, 1, 1, 0, undefined, undefined, 5);
	undyne = scr_marker_ext(320, 216, 3426, 1, 1, 0, undefined, undefined, 6);
	bush1 = scr_marker_ext(291, 191, 4331, 1, 1, 0, undefined, undefined, 30);
	bush2 = scr_marker_ext(288, 199, 1506, 1, 1, 0, undefined, undefined, 30);
