...
if (con == 50 && !d_ex() && customcon == 1) {
	...
	c_wait(15);
	c_var_instance(gerson_npc, "current_sprite_index", 3328);
	...
	c_wait(60);
	c_var_instance(gerson_npc, "current_state", 0);
	c_var_instance(gerson_npc, "current_sprite_index", 2636);
	c_wait(15);
	c_speaker("gerson");
	...
	c_var_instance(gerson_npc, "facing_right", false);
	c_wait(30);
	c_var_instance(gerson_npc, "current_sprite_index", 3177);
	c_speaker("gerson");
