...
if (play) {
	...
	if (type == 4) {
		var _pull_a = audio_sound_set_track_position(snd_play(294, 1, 2), 0.06);
		var _pull_b = audio_sound_set_track_position(snd_play(294, 1, 0.8), 0.06);
	}
	...
	if (type == 2) {
		...
		punch++;
		snd_play(323, 1, (punch == 1) ? 0.9 : 1.1);
