...
if (con == 5) {
	...
	if (timer > 0) {
		...
		if (timer < delay) {
			...
			if (timer == (delay + 30)) {
				whiteout = scr_marker_ext(0, 0, 1021, room_width, room_height, undefined, undefined, 16777215, 101);
			...
			if (timer == (delay + 8 + jumptime)) {
				...
				blackout = scr_marker_ext(0, 0, 1021, room_width, room_height, undefined, undefined, 0, 102);
			}
