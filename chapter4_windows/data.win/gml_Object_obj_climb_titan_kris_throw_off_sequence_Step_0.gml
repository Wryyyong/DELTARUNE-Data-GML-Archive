if (con == 1) {
	...
	if (!tower2) {
		...
		if (timer == 30) {
			whiteout = scr_marker_ext(0, 0, 1021, room_width, room_height, undefined, undefined, 16777215, obj_rotating_kris_controller_new.depth + 1);
		...
		if (timer == 80) {
			...
			blackout = scr_marker_ext(0, 0, 1021, room_width, room_height, undefined, undefined, 0, obj_rotating_kris_controller_new.depth + 2);
		}
