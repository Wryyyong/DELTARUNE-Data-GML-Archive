...
pattern_bigshots = function() {
	...
	if (timer == 96 || timer == 126) {
		...
		with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, 180, 13)) {
...
pattern_bigshots_aimed = function() {
	...
	if (timer == 96 || (timer == 104 && phaser) || (timer == 112 && phaser > 1) || timer == 126 || (timer == 134 && phaser) || (timer == 142 && phaser > 1)) {
		...
		with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, aim_var, 13)) {
...
pattern_desperation_shots = function() {
	...
	if (timer == 48) {
		snd_play(289, 1, 0.35);
		var extra_spicy = snd_play(51, 1, 0.15);
	...
	if (timer >= 96 && (timer % 10) == 0 && timer > 2400) {
		...
		with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, 160 + timer_alt, 18)) {
			scr_script_delayed(scr_sonic_boom, 1, direction);
			scr_script_delayed(scr_sonic_boom, 5, direction);
			scr_script_delayed(scr_sonic_boom, 9, direction);
			xmod = 1.25;
	...
	if (timer >= 96 && (timer % 10) == 0 && timer < 220) {
		...
		if (timer_alt == 1) {
			with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, scr_at_player(obj_growtangle.x + 250, obj_darkshape_blast_tester.y), 8)) {
				scr_script_delayed(scr_sonic_boom, 1, direction);
				scr_script_delayed(scr_sonic_boom, 5, direction);
				scr_script_delayed(scr_sonic_boom, 9, direction);
				xmod = 1.25;
			...
			for (var aa = 1; aa < 2; aa++) {
				with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, scr_at_player(obj_growtangle.x + 250, obj_darkshape_blast_tester.y) + (35 * aa) + irandom_range(-5, 5), 8 + irandom_range(-3, 3))) {
					scr_script_delayed(scr_sonic_boom, 1, direction);
					scr_script_delayed(scr_sonic_boom, 5, direction);
					scr_script_delayed(scr_sonic_boom, 9, direction);
					xmod = 1.25;
			...
			for (var aa = 1; aa < 2; aa++) {
				with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, scr_at_player(obj_growtangle.x + 250, obj_darkshape_blast_tester.y) + (18 * aa) + irandom_range(-2, 2), 8 + irandom_range(-3, 3))) {
					scr_script_delayed(scr_sonic_boom, 1, direction);
					scr_script_delayed(scr_sonic_boom, 5, direction);
					scr_script_delayed(scr_sonic_boom, 9, direction);
					xmod = 1.25;
	...
	if (timer == 220) {
		with (scr_fire_bullet(obj_growtangle.x + 276, obj_darkshape_blast_tester.y, 873, 0, 0))
...
pattern_desperation_shots_short = function() {
	...
	if (timer >= 96 && (timer % 20) == 0) {
		...
		if (timer_alt == 1) {
			...
			for (var aa = 1; aa < 2; aa++) {
				with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, scr_at_player(obj_growtangle.x + 250, obj_darkshape_blast_tester.y) + (25 * aa) + irandom_range(-5, 5), 8 + irandom_range(-3, 3))) {
					scr_script_delayed(scr_sonic_boom, 1, direction);
					scr_script_delayed(scr_sonic_boom, 5, direction);
					scr_script_delayed(scr_sonic_boom, 9, direction);
			...
			for (var aa = 1; aa < 2; aa++) {
				with (scr_fire_bullet(obj_growtangle.x + 240, obj_darkshape_blast_tester.y, 459, scr_at_player(obj_growtangle.x + 250, obj_darkshape_blast_tester.y) + (12 * aa) + irandom_range(-2, 2), 8 + irandom_range(-3, 3))) {
					scr_script_delayed(scr_sonic_boom, 1, direction);
					scr_script_delayed(scr_sonic_boom, 5, direction);
					scr_script_delayed(scr_sonic_boom, 9, direction);
