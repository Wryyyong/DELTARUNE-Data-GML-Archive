...
if (type == 147) {
	if (!made) {
		...
		with (scr_fire_bullet(obj_growtangle.x - 80, obj_growtangle.y - 32, 800, 45, 1)) {
			hspeed = 1;
			vspeed = 1;
		}
		
		with (scr_fire_bullet(obj_growtangle.x, obj_growtangle.y - 32, 800, 45, 1)) {
			hspeed = -1.5;
			vspeed = 0.5;
		}
...
if (type == 150) {
	if (!made) {
		...
		with (scr_fire_bullet(obj_growtangle.x - 44, obj_growtangle.y + 70, 800, 135, 1, 2998, false, false, -11)) {
...
if (type == 154) {
	if (!made) {
		...
		with (scr_fire_bullet((obj_growtangle.x - 156) + irandom(8), (obj_growtangle.y + 54) - irandom(8), 800, 45, 1)) {
			_flip = choose(-1, 1);
		...
		with (scr_fire_bullet((obj_growtangle.x - 98) + irandom(8), (obj_growtangle.y + 54) - irandom(8), 800, 45, 1)) {
			_flip = choose(-1, 1);
			var __flip = choose(-1, -1);
			hspeed = 1 * _flip;
			vspeed = 1 * __flip;
		...
		with (scr_fire_bullet((obj_growtangle.x - 98) + irandom(8), (obj_growtangle.y + 114) - irandom(8), 800, 45, 1)) {
			_flip = choose(-1, 1);
			var __flip = choose(-1, -1);
			hspeed = 1 * _flip;
			vspeed = 1 * __flip;
...
if (type == 156) {
	...
	if (timer1 > (8 + irandom(7))) {
		...
		scr_fire_bullet((obj_growtangle.x + (irandom(22) * 6)) - 66, (obj_growtangle.y - 180) + random(10), 1275, 270, 5, 2494, false, true, 10);
	}
	...
	if (timer2 > (5 + irandom(6))) {
		...
		repeat (1 + !irandom(3))
			scr_fire_bullet((obj_growtangle.x + (irandom(22) * 6)) - 66, (obj_growtangle.y - 180) + random(10), 219, 270, 4 + random(5), 4546, false, true, 10);
	}
}
