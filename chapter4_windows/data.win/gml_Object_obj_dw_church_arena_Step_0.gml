...
if (con == 2) {
	...
	c_wait(60);
	c_var_instance(gerson_npc, "current_state", 0);
	c_var_instance(gerson_npc, "current_sprite_index", 5111);
	c_speaker("gerson");
	...
	c_wait(10);
	c_var_instance(gerson_npc, "current_state", 0);
	c_var_instance(gerson_npc, "current_sprite_index", 3386);
	c_wait(4);
	c_wait(30);
	c_var_instance(gerson_npc, "current_sprite_index", 2273);
	c_wait(60);
	c_speaker("susie");
	...
	c_var_instance(id, "susie_attack_timer", 0);
	c_wait(12);
	c_var_instance(gerson_npc, "current_sprite_index", 2001);
	c_var_lerp_to_instance(gerson_npc, "x", 921, 12, 3, "out");
	c_wait(8);
	c_var_instance(id, "susie_attack_timer", 0);
	c_wait(8);
	c_var_instance(gerson_npc, "current_sprite_index", 2203);
	...
	c_var_instance(gerson_npc, "current_sprite_index", 5703);
	c_sound_play_x(331, 1, 0.9);
	c_sprite(spr_susieb_attack);
	c_var_lerp_to("image_index", 5, 6);
	c_var_lerp_to("x", 840, 6);
	c_wait(3);
	c_var_instance(gerson_npc, "current_sprite_index", 5422);
	c_wait(3);
...
if (con == 30 && customcon == 1 && !i_ex(obj_battlecontroller)) {
	...
	c_var_instance(gerson_npc, "facing_right", false);
	c_var_instance(gerson_npc, "current_state", 0);
	c_var_instance(gerson_npc, "current_sprite_index", 4457);
	c_var_instance(gerson_npc, "x", 840);
	c_var_instance(gerson_npc, "y", 210);
	c_wait(30);
