flooractive = 1;
bookshelf = scr_marker_ext(1560, 1080, 5163, 2, 2);
bookshelf2 = scr_marker_ext(1440, 1080, 5163, 2, 2);
ladder = scr_marker_ext(520, 1120, 5763, 2, 2, undefined, undefined, undefined, 999999);
book = scr_marker_ext(1502, 1046, 1021, 10, 18, undefined, undefined, 16711680, 900000);
