if (!init) {
	...
	ranpc.talked = 0;
	ranpc.strict = true;
	ranpc.marker = scr_marker_ext(ramark[0], ramark[1], 389, 2, 2, 0, undefined, undefined, undefined, 1);
...
if (telecon == 3) {
	...
	if (tele_scon == 1) {
		...
		if (sunpc.marker.image_index == 7) {
			...
			snd_play(410, 0.7, 1.4);
			var snd = snd_play(318, 0, 1.2);
			snd_volume(snd, 1, 15);
		}
