...
if (watercoolerfight == 0) {
	...
	if (trig) {
		npc4.myinteract = 99;
		watercoolerfight = 1;
		watermarker = scr_marker_ext(camerax() + 640 + 120, obj_mainchara.y - 12, 2132, 2, 2, 0, undefined, undefined, 5000);
...
if (slidecon == 0) {
	if (scr_trigcheck("slideEnter")) {
		...
		fade = scr_marker_ext(0, 0, 1021, room_width, room_height, 0, undefined, 0, -99, undefined, undefined, 0);
