...
if (con == 72) {
	...
	if (timer == 15) {
		...
		dog = scr_marker_ext(camerax() + 640, kris.y - 10, 3488, 2, 2, 0.5, undefined, undefined, kris.depth - 1);
...
if (i_ex(dog) && con == 73) {
	with (dog) {
		if (x <= (other.kris.bbox_right - 10) && x > (camerax() - 100)) {
			...
			other.con = 74;
			other.timer = 0;
			other.blackout = scr_marker_ext(camerax(), cameray(), 1021, 640, 480, undefined, undefined, 0, -4, undefined, undefined, 1);
		}
	}
}
