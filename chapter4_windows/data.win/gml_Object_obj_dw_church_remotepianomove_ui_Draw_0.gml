	...
	if (view_current == 0) {
		...
		if (soundtoplay == 5) {
			...
			if (button1_p() && makenote == 1) {
				...
				with (scr_marker_ext(xloc, yloc, arrowspr, xscale, yscale, undefined, undefined, 16777215, depth - 2)) {
					image_angle = angle;
					var lifetime = 10;
		...
		if (soundtoplay == 0) {
			...
			if (button1_p() && makenote == 1) {
				...
				with (scr_marker_ext(xloc, yloc, circlespr, xscale, yscale, undefined, undefined, 16777215, depth - 2)) {
					image_angle = angle;
					var lifetime = 10;
					scr_lerpvar("image_alpha", 2, 0, lifetime, 2, "out");
					scr_doom(id, lifetime);
