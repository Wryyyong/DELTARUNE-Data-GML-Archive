...
if (global.plot < 141) {
	...
	gerson = scr_marker_ext(2680, 1118, 2273, 2, 2, 0, 0, undefined, 91020);
...
if (global.plot >= 150 && global.plot < 225) {
	sparkle = scr_makenpc_fromasset(findsprite(3519, "DEBUG_ASSETS"));
	sparkle.siner = 0;
...
if (global.plot >= 225)
	turtle = scr_makenpc_fromasset(findsprite(3785, "DEBUG_ASSETS"));

memspeed = -1;
depth = 0;
var saveLoc = findspriteinfo(1313, "DEBUG_ASSETS");
...
if (global.plot >= 242)
	organik = scr_makenpc_fromasset(findsprite(1614, "DEBUG_ASSETS"));
