...
with (turtle) {
	...
	if (myinteract == 4 && !d_ex()) {
		...
		var pausetime = 10;
		var col = 8019622;
		pink = scr_marker_ext(camerax() - 10, cameray() - 10, 1021, 660, 500, undefined, undefined, col, 0, undefined, undefined, 0);
		
		with (pink)
			scr_lerpvar("image_alpha", 0, 1, fadeintime, 2, "out");
		
		snd_play_delay(319, fadeintime);
		myinteract = 4.1;
	...
	if (myinteract == 5) {
		...
		with (scr_marker_ext(camerax() - 10, cameray() - 10, 1021, 660, 500, undefined, undefined, 16777215, 5, undefined, undefined, 1)) {
