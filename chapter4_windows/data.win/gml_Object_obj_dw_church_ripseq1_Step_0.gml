...
if (!init) {
	...
	gersonmark1 = scr_marker_ext(pos[0], pos[1], 3823, 2, 2, 0, 0, col);
	gersonmark1.touched = false;
	pos = scr_heromarker("any", "ger2");
	gersonmark2 = scr_marker_ext(pos[0], pos[1], 3823, 2, 2, 0, 0, col);
	gersonmark2.touched = false;
	pos = scr_heromarker("any", "ger3");
	gersonmark3 = scr_marker_ext(pos[0], pos[1], 3823, 2, 2, 0, 0, col);
...
if (makerip) {
	...
	if (!instance_exists(chaser)) {
		chaser = scr_marker_ext(xx, yy, 2642, 2, 2, 0.25, undefined, undefined, 5000);
	} else {
		snd_play_delay(99, 5, 0.4, 1);
		snd_play_delay(99, 10, 0.2, 1);
	}
