if (!init) {
	...
	germark = scr_marker_ext(ger[0], ger[1], 3823, 2, 2, 0, undefined, 0, undefined, 1);
	init = 1;
}
...
if (dogerson == 1) {
	...
	with (scr_marker_ext(pos[0], pos[1] + offset, 3823, 2, 2, 0.25, undefined, 0, undefined, 1)) {
		hspeed = 8;
		scr_doom(id, 60);
	}
	...
	with (scr_marker_ext(pos[0], (pos[1] + offset + 240) - 8, 3823, 2, -4, 0.25, undefined, 0, undefined, 1)) {
		hspeed = 8;
		scr_doom(id, 60);
	}
	
	snd_play(snd_step1);
	snd_play_delay(349, 4, 0.7);
	snd_play_delay(348, 8, 0.4);
	snd_play_delay(349, 12, 0.2);
	dogerson = 2;
}
