...
gentimer = 0;
defender1 = 0;
var ws1 = findspriteinfo(1298, "DEBUG_ASSETS", 255);
var ws2 = findspriteinfo(1298, "DEBUG_ASSETS", 16711680);
wallswitch[0] = scr_marker_ext(ws1.x, ws1.y, 1298, 2, 2, 0, undefined, undefined, 99990);
wallswitch[1] = scr_marker_ext(ws2.x, ws2.y, 1298, 2, 2, 0, undefined, undefined, 99990);
triginit = 0;
forcefall = 0;
tickcount = 0;
canceltimer = 0;
