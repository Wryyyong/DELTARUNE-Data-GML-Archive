...
timer = 0;
econ = 0;
organicstatue = scr_marker_ext(440, 158, 5814, 2, 2, undefined, undefined, undefined, undefined, 1);
		...
		for (var j = 0; j < array_length(elements); j++) {
			if (layer_get_element_type(elements[j]) == 4) {
				...
				with (layersprite[sprite_array_size]) {
					...
					if (y >= 202)
						scr_marker_ext(x, y + 8, sprite_index, image_xscale, image_yscale, image_speed, image_index, 0, depth - 1);
				}
...
depth = 999990;
var _depth = 96750;
leftmarker = scr_marker_ext(0, 0, 1021, 360, room_height, 0, undefined, 0, _depth, undefined, undefined, 0.5);
leftmarker = scr_marker_ext(600, 0, 1021, 360, room_height, 0, undefined, 0, _depth, undefined, undefined, 0.5);
enemarker = -4;
