if (!init) {
	...
	susie = scr_marker_ext(x, y, 429, 2, 2, undefined, undefined, undefined, undefined, 1);
...
if (enemcon == 1 && !d_ex()) {
	...
	if (timer == 8) {
		...
		angymarker = scr_marker_ext(angyboy.marker.x - 16 - 2, (angyboy.marker.y - 16) + 2, 4466, 2, 2, 0, 0, 16777215, angyboy.marker.depth + 1);
	}
