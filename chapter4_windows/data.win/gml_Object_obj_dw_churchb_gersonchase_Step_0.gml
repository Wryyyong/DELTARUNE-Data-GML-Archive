...
if (!init) {
	...
	if (global.tempflag[51] != 0) {
		with (obj_mainchara) {
			...
			var offset = findspriteinfo(4296, "DEBUG_ASSETS").y;
	...
	germark1 = scr_marker_ext(pos[0], pos[1], 5864, 2, 2, 0, 0, undefined, undefined, 1);
	germark1.image_blend = c_black;
	germark1.con = 0;
	germark1.timer = 14;
	pos = scr_heromarker(undefined, "notgerson2");
	germark2 = scr_marker_ext(pos[0], pos[1], 5864, 2, 2, 0, 0, undefined, undefined, 1);
...
if (con == 11) {
	if (scr_trigcheck("end")) {
		darkcount = 6;
		global.interact = 1;
		blackout = scr_marker_ext(camerax() - 20, cameray() - 20, 1021, 680, 520, undefined, undefined, 0, 5000, undefined, undefined, 0);
