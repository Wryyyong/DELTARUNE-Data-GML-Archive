...
if (con < 99) {
	...
	if (con == 0) {
		...
		if (cutscene == 0 && kris.x > darkness_midx) {
			...
			c_customfunc(function() {
				...
				su_hunch = scr_dark_marker_fancy(su_actor.x - 2, su_actor.y + 6, 4751);
	...
	if (con == 2) {
		...
		scr_maincharacters_actors();
		c_customfunc(function() {
			su_hunch = scr_dark_marker_fancy(su_actor.x, su_actor.y, 5267);
			...
			ra_hunch = scr_dark_marker_fancy(ra_actor.x, ra_actor.y, 1228);
