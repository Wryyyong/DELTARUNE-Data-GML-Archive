...
spread = 350;
active = false;
kris = scr_custom_marker_depth(camerax() + 220, cameray() + 60, depth, 89, 4478);
kris.sub_sprites = 8;
kris.image_speed = 0.6;
kris.sub_index = 1;
susie = scr_custom_marker_depth(camerax() + 420, cameray() + 60, depth, 89, 5099);
susie.sub_sprites = 8;
susie.image_speed = 0.6;
susie.sub_index = 7;
kris_over = scr_custom_marker_depth(camerax() + 220, cameray() + 60, depth, 89, 4654);
kris_over.image_alpha = 0;
susie_over = scr_custom_marker_depth(camerax() + 420, cameray() + 60, depth, 89, 5078);
