...
if (con == 2) {
	...
	c_wait(5);
	c_snd_play_x(514, 1, 0.5);
	c_snd_play_x(514, 1, 0.4);
	c_wait(_xease - 10);
	...
	c_customfunc(function() {
		scr_lerp_imageblend(kris, 16777215, 0, 240);
		scr_lerp_imageblend(susie, 16777215, 0, 240);
	});
	c_wait(85);
