...
ossafe_fill_rectangle_color(camerax(), yy - 2, camerax() + view_wport[0], yy, 65535, 65535, 65535, 65535, 0);
ossafe_fill_rectangle_color(camerax(), yy, camerax() + view_wport[0], yy + margin_top + 40, 0, 0, 0, 0, 0);
ossafe_fill_rectangle_color(camerax(), yy + margin_top + 40, camerax() + view_wport[0], yy + margin_top + 40 + 1, 65535, 65535, 65535, 65535, 0);
