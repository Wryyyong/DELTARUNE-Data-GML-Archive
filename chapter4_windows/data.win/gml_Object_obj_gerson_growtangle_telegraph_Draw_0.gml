...
if (special == 0) {
	...
	ossafe_fill_rectangle_color(x1, y1, x2, y2, 16777215, 16777215, 16777215, 16777215, false);
	draw_set_alpha(1);
}
...
if (special > 0) {
	...
	if (special == 3) {
		draw_set_alpha(image_alpha);
		ossafe_fill_rectangle_color(obj_growtangle.x - 30, obj_growtangle.y - 53, obj_growtangle.x + 32, obj_growtangle.y + 53, 16777215, 16777215, 16777215, 16777215, false);
		draw_set_alpha(1);
	}
	
	if (special == 4) {
		draw_set_alpha(image_alpha);
		ossafe_fill_rectangle_color(obj_growtangle.x - 53, obj_growtangle.y + 30, obj_growtangle.x + 53, obj_growtangle.y - 32, 16777215, 16777215, 16777215, 16777215, false);
		draw_set_alpha(1);
	}
}
