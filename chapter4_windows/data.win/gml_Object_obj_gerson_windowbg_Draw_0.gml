timer++;
ossafe_fill_rectangle_color(camerax(), cameray(), camerax() + 640, cameray() + 164, 9609056, 9609056, 6716182, 6716182, 0);
...
ossafe_fill_rectangle_color(camerax() + 0, cameray() + 164, camerax() + 640, cameray() + 480, 0, 0, 0, 0, 0);
