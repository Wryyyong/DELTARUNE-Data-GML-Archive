...
if (timer == 42) {
	...
	if (pop == sameattack) {
		with (scr_fire_bullet(t_x, t_y, 1275, temp_angle, (3.75 - (0.5 * pop)) + (0.25 * sameattacker), 3934)) {
			damage = other.damage;
			target = other.target;
			grazepoints = 2.5;
		...
		with (scr_fire_bullet(t_x + lengthdir_x(40, temp_angle - 155), t_y + lengthdir_y(40, temp_angle - 155), 1275, temp_angle - 3 - (pop * 3), (7.25 - (0.5 * pop)) + (0.25 * sameattacker), 3934)) {
			damage = other.damage;
			target = other.target;
			grazepoints = 2.5;
			image_angle = other.temp_angle;
		...
		with (scr_fire_bullet(t_x + lengthdir_x(80, temp_angle - 155), t_y + lengthdir_y(80, temp_angle - 155), 1275, temp_angle - 6 - (pop * 3), (10.75 - (0.5 * pop)) + (0.25 * sameattacker), 3934)) {
			damage = other.damage;
			target = other.target;
			grazepoints = 2.5;
			image_angle = other.temp_angle;
		...
		with (scr_fire_bullet(t_x + lengthdir_x(80, temp_angle - 170), t_y + lengthdir_y(80, temp_angle - 170), 1275, temp_angle - 3 - (pop * 3), (7.25 - (0.5 * pop)) + (0.25 * sameattacker), 3934)) {
			damage = other.damage;
			target = other.target;
			grazepoints = 2.5;
			image_angle = other.temp_angle;
