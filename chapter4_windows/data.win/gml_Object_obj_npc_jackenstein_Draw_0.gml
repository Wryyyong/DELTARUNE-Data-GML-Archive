...
if (state == 5) {
	...
	for (var i = 0; i < 6; i++) {
		scr_draw_beam(x + 25, y + 48, 800, beam_width, beam_rotation + (60 * i), 16777215, 1, false);
		scr_draw_beam(x + 50, y + 44, 800, beam_width, beam_rotation + 25 + (60 * i), 16777215, 1, false);
	}
