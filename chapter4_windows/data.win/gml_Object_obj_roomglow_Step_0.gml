if (init == false) {
	...
	create_highlight(1049);
	create_highlight(1235);
	...
	if (fadeparallax) {
		if (layer_exists("PARALLAX_1")) {
			...
			var bgmark = scr_marker_ext(0, 0, 1021, room_width, room_height, undefined, undefined, 0, targdepth);
