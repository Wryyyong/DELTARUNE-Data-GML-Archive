...
if (endingcon == 1 && introcon == 0) {
	...
	if (endingtimer == 60) {
		...
		scr_battle_sprite_set("susie", 1574, 0.5, true);
...
if (endingcon == 4) {
	...
	if (endingtimer == 1) {
		obj_herosusie.x -= 35;
		obj_herosusie.y -= 28;
		scr_battle_sprite_set("susie", 3473, 0.5, false);
	...
	if (endingtimer == 14) {
		scr_battle_sprite_set("susie", 48, 0.5, true);
...
if (endingcon == 8) {
	...
	if (endingtimer == 1)
		scr_battle_sprite_set("susie", 3400, 0.5, false);
	...
	if (endingtimer == 6) {
		...
		scr_battle_sprite_set("susie", 3098, 0.5, true);
	}
