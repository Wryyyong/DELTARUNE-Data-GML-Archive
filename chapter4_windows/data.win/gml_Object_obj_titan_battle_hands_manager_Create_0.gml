...
hand_direction = 0;
wave_counter = 0;
hand_1 = scr_fire_bullet(x, y, 1275, 0, 0, 4035);
hand_2 = scr_fire_bullet(x, y, 1275, 0, 0, 4035);
hand_1_overload = -1;
hand_2_overload = -1;
hand_1.grazed = 1;
hand_2.grazed = 1;
...
with (hand_1) {
	...
	finger_1 = scr_fire_bullet(x, y, 624, 0, 0);
	finger_2 = scr_fire_bullet(x, y, 624, 0, 0);
	finger_3 = scr_fire_bullet(x, y, 624, 0, 0);
	finger_4 = scr_fire_bullet(x, y, 624, 0, 0);
	finger_1.master = id;
	finger_2.master = id;
	finger_3.master = id;
	finger_4.master = id;
...
wibbly_bullets = function(arg0, arg1, arg2) {
	with (scr_fire_bullet(arg0.x + lengthdir_x(arg2, image_angle + 180) + lengthdir_x(arg1, image_angle - 90), arg0.y + lengthdir_y(arg2, image_angle + 180) + lengthdir_y(arg1, image_angle - 90), 1275, arg0.image_angle + irandom_range(-25, 25), 0, 3652)) {
		grazed = 1;
		grazepoints = 0;
		damage = 90;
		target = 4;
...
wibbly_bullets2 = function(arg0, arg1, arg2) {
	with (scr_fire_bullet(arg0.x + lengthdir_x(arg2, image_angle) + lengthdir_x(arg1, image_angle + 90), arg0.y + lengthdir_y(arg2, image_angle) + lengthdir_y(arg1, image_angle + 90), 1275, arg0.image_angle + irandom_range(-25, 25), 0, 3652)) {
		grazed = 1;
		grazepoints = 0;
		damage = 90;
		target = 4;
