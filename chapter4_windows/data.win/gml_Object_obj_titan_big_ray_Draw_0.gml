...
draw_triangle_color(x - __view_get(e__VW.XView, 0), y - __view_get(e__VW.YView, 0), x2 - __view_get(e__VW.XView, 0), y2 - __view_get(e__VW.YView, 0), x3 - __view_get(e__VW.XView, 0), y3 - __view_get(e__VW.YView, 0), 16777215, 16777215, 16777215, false);
draw_triangle_color(x - __view_get(e__VW.XView, 0), y - __view_get(e__VW.YView, 0), x22 - __view_get(e__VW.XView, 0), y22 - __view_get(e__VW.YView, 0), x33 - __view_get(e__VW.XView, 0), y33 - __view_get(e__VW.YView, 0), 0, 8421504, 8421504, false);
