...
if (global.monster[myself] == 1) {
	...
	if (endingcon == 1) {
		...
		if (endingtimer == 180) {
			...
			scr_battle_sprite_set("susie", 3686, 0, 1);
	...
	if (endingcon == 2) {
		...
		if (endingtimer == 70) {
			...
			scr_battle_sprite_set("susie", 5028, 0, 1);
		}
...
if (global.myfight == 3) {
	...
	if (acting == 1.24 && actcon == 0) {
		...
		if (endingtimer == 1) {
			...
			scr_battle_sprite_set("susie", 5378, 0, 0);
	...
	if (actcon == 21) {
		scr_battle_sprite_set("susie", 5532, 1/3, 0);
	...
	if (actcon == 22) {
		...
		if (acttimer >= 20) {
			...
			scr_battle_sprite_set("susie", 3128, 1/3, 1);
			global.faceaction[1] = 2;
			actcon = 1;
			dualhealcon = 1;
		}
